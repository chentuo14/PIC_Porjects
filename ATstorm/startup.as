	...
	;This licence will expire on Thu, 07 Sep 2017
	...
	; Compiler options:
	;
	; -oATstorm.cof -mATstorm.map --summary=default --output=default \
	; Main.p1 usart.p1 i2c.p1 --chip=16F88 -P --runtime=default \
