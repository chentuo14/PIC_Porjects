...
#define SCL             RB4             /* clock on port C bit 2 */
#define SCL_DIR         TRISB4
#define SDA     		RB1             /* data on port C bit 1 */
...
#define I2C_TM_BUS_FREE		50
#define	I2C_TM_START_SU		50
#define I2C_TM_START_HD		40
#define I2C_TM_SCL_LOW		50
#define	I2C_TM_SCL_HIGH		40
#define I2C_TM_DATA_SU		10
#define I2C_TM_DATA_HD          0
#define I2C_TM_SCL_TO_DATA	40	/* SCL low to data valid */
